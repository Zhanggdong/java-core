package com.greworld.datatructure.queue;

import com.greworld.datatructure.linkedlist.MyCollection.SortMyLinkedList;
...
/**
 * @author 风骚的GRE
 * @Description 优先队列的简单实现,采用排序双链表,T必须实现Comparable接口
 * @date 2018/2/28.
 */
