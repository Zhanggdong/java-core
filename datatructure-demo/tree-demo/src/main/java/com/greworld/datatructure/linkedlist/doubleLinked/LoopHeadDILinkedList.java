package com.greworld.datatructure.linkedlist.doubleLinked;

import com.greworld.datatructure.linkedlist.ILinkedList;

/**
 * @author 风骚的GRE
 * @Description 循环双链表,带空头结点(不含数据),循环链表可以不需要尾部指针
 * @date 2018/2/28.
 */
